...
export function AppHeader({ links = [] }: { links: { label: string; path: string }[] }) {
  ...
  <div className="max-w-screen-xl mx-auto flex flex-wrap justify-between items-center gap-4">
    <div className="flex items-center gap-3 flex-wrap">
      <Image src="/third-time-icon-tiny-white.png" alt="Third Time" width={80} height={40} />
      <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-center px-4 break-words whitespace-normal leading-snug">
